...
CREATE TABLE "followers" (
	"id" serial NOT NULL,
	"accountFollowed" int NOT NULL,
	"whoFollowed" int NOT NULL,
...
ALTER TABLE "followers" ADD CONSTRAINT "followers_fk0" FOREIGN KEY ("accountFollowed") REFERENCES "users"("id");
ALTER TABLE "followers" ADD CONSTRAINT "followers_fk1" FOREIGN KEY ("whoFollowed") REFERENCES "users"("id");
